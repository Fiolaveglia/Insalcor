    ...
    <div class="wrapper clearfix" id="wrapperParallax">
      ...
      <section class="blog blog-grid" id="blog">
        <div class="container">
          ...
          <div class="row">
            <?php if ($noticias) {
                foreach ($noticias as $item) { echo render_noticia_card($item, $detailBase); }
            } else { ?>
              ...
              <div class="blog-entry" data-hover="">
                <div class="entry-img">
                  <div class="entry-date">
                    ...
                    <a href="#"><img src="assets/images/blog/grid/1.jpg" alt=""/></a>
                </div>
                <div class="entry-content">
                  ...
                  <div class="entry-title">
                    <h4><a href="#">Titulo del tutorial</a></h4>
                  </div>
                  <div class="entry-bio">
                  ...
                  <div class="entry-more"> <a class="btn btn--primary btn-line btn-line-before btn-line-inversed tutorial" href="#"> 
