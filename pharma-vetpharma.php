...
<html dir="ltr" lang="<?= e(current_lang()) ?>">
  ...
  <body data-i18n-base="assets/i18n" data-lang="es" data-api-root="." data-asset-prefix="" data-product-detail="product-single.php">
    ...
    <div class="wrapper clearfix" id="wrapperParallax">
      ...
      <!-- probando otras Cards de Pharma y VetPharma -->
      <!-- <section class="Pharma-VetPharma-Cards">
        <div class="container">
          ...
          <div class="col-12 col-md-6 col-lg-4">
              <div class="blog-entry">
                ...
                <div class="entry-content">
                  <div class="entry-title">
                    <h4><a href="blog-single-sidebar.html">VetPharma</a></h4>
                  </div>
                  <div class="entry-more"> <a class="btn btn--white btn-line btn-line-before btn-line-inversed" href="blog-single-sidebar.html"> 
                      <div class="line"> <span> </span></div><span>Ver productos</span></a></div>
                </div>
              </div>
          </div>
          </div>
      ...
      <!-- Selector Pharma / VetPharma -->
      <section class="segment-switch" id="segment-switch">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
              <div class="segment-switch__wrap">
      ...
      <!-- SEGMENTO: PHARMA -->
      <div id="segment-pharma" class="segment-content is-visible">
      ...
      <section class="blog grey-light-bg blog-grid blog-grid-3" id="blog-2">
        <div class="container">
          ...
          <!-- End .row-->
          <?php if ($pharmaNoticias): ?>
          <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="2" data-autoplay="<?= count($pharmaNoticias) > 3 ? 'true' : 'false' ?>" data-nav="false" data-dots="true" data-space="30" data-loop="<?= count($pharmaNoticias) > 3 ? 'true' : 'false' ?>" data-speed="200">
            <?php foreach ($pharmaNoticias as $item) { echo render_noticia_slide($item, 'blog-single.php'); } ?>
          </div>
          <!-- End .carousel-->
          <?php else: ?>
          <div class="row">
              ...
              <div class="blog-entry">
                ...
                <div class="entry-content">
                  <div class="entry-meta">
                    <div class="entry-category"><a href="javascript:void(0)" style="cursor: default;">Pharma</a>
                    </div>
      ...
      <!-- SEGMENTO: VETPHARMA -->
      <div id="segment-vetpharma" class="segment-content">
      <!--Products Section-->
      <section class="shop" id="shop">
        <div class="container">
          <div class="row">
      ...
      <section class="blog blog-grid blog-grid-3" id="blog-2">
        ...
        <div class="row g-4 mt-4">
          <?php if ($vetNoticias) {
              foreach ($vetNoticias as $item) { echo render_noticia_card($item, 'blog-single.php'); }
          } else { ?>
            <div class="col-12"><p class="text-center"><?= e(t('common.no_news')) ?></p></div>
          <?php } ?>
          </div>
